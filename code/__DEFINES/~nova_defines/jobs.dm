...
#define SEC_RESTRICTED_QUIRKS "Brain Tumor" = TRUE, "Paraplegic" = TRUE, "Hemiplegic" = TRUE,  "Foreigner" = TRUE, "Pacifist" = TRUE, "No Guns" = TRUE, "Illiterate" = TRUE, "Nerve Stapled" = TRUE, "Underworld Connections" = TRUE, "Stowaway" = TRUE, "Paroled Convict" = TRUE  //IRIS EDIT - Adds Stowaway, removes Blind, Deaf and Mute
...
#define GUARD_RESTRICTED_QUIRKS "Foreigner" = TRUE, "Pacifist" = TRUE, "Nerve Stapled" = TRUE, "Stowaway" = TRUE, "Underworld Connections" = TRUE, "Paroled Convict" = TRUE  //IRIS EDIT - Adds Stowaway, Convict and Underworld Connections, removes Blind and Deaf
