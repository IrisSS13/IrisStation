...
#define BODYPART_ICON_ROUNDSTARTSLIME 'modular_iris/modules/bodyparts/icons/slime_parts_greyscale.dmi' // IRIS EDIT CHANGE - ORIGINAL: #define BODYPART_ICON_ROUNDSTARTSLIME 'modular_nova/modules/bodyparts/icons/slime_parts_greyscale.dmi'
