...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		//IRIS ADDITION - EXTRA-SENSORY PARANOIA QUIRK AS PART OF https://github.com/Monkestation/Monkestation2.0/pull/313
		...
		// IRIS ADDITION BEGIN - STOWAWAY QUIRK
	...
	/obj/item = list(
		"TRAIT_MINING_ITEM" = TRAIT_MINING_ITEM, // IRIS ADDITION
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_FLOATING_HELD" = TRAIT_FLOATING_HELD, //IRIS EDIT
	),
