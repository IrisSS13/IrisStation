...
/datum/controller/subsystem/dynamic/proc/send_intercept()
	...
	. = "<b><i>Nanotrasen Department of Intelligence Threat Advisory, Cabriole Sector, TCD [time2text(world.realtime, "DDD, MMM DD", NO_TIMEZONE)], [CURRENT_STATION_YEAR]:</i></b><hr>"
...
//IRIS EDIT: SPINWARD TO CABRIOLE
