...
/datum/communciations_controller/proc/send_roundstart_report(greenshift)
	...
	. = "<b><i>Nanotrasen Department of Intelligence Threat Advisory, Cabriole Sector, TCD [time2text(world.realtime, "DDD, MMM DD")], [CURRENT_STATION_YEAR]:</i></b><hr>" // IRIS EDIT - SPINWARD TO CABRIOLE
	. += dynamic_report
