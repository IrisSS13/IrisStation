...
/datum/communciations_controller/proc/send_roundstart_report(greenshift)
	...
	. = "<b><i>Nanotrasen Department of Intelligence Threat Advisory, Cabriole Sector, TCD [time2text(world.timeofday, "DDD, MMM DD")], [CURRENT_STATION_YEAR]:</i></b><hr>" // Iris Edit, Spinward>Cabriole
	. += dynamic_report
