...
/datum/memory/proc/generate_story(story_type, story_flags)
	...
	if(story_flags & STORY_FLAG_DATED)
		if(memory_flags & MEMORY_FLAG_NOSTATIONNAME)
			parsed_story += "This took place in [time2text(world.timeofday, "Month")] of [CURRENT_STATION_YEAR]."
		else
			parsed_story += "This took place in [time2text(world.timeofday, "Month")] of [CURRENT_STATION_YEAR] on [station_name()]."
