...
/obj/item/disk/nuclear/proc/secured_process(last_move)
	...
	var/datum/round_event_control/operative/loneop = locate(/datum/round_event_control/operative) in SSgamemode.control //Iris edit - changed to work with Storyteller - Old code: 	var/datum/round_event_control/operative/loneop = locate(/datum/round_event_control/operative) in SSevents.control
