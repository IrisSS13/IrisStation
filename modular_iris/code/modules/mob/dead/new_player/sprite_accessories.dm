...
/datum/sprite_accessory/hair/wicked // bubber port
	name = "Wicked"
	icon = 'modular_iris/icons/mob/species/human/hair.dmi'
	icon_state = "hair_wicked"

/datum/sprite_accessory/hair/short_bob //cepha - bubber port start
	name = "Short Bob"
	icon = 'modular_iris/icons/mob/species/human/hair.dmi'
...
/datum/sprite_accessory/hair/tails_berly
	name = "Ponytails (Berly)"
	icon = 'modular_iris/icons/mob/species/human/hair.dmi'
	icon_state = "hair_tails_berly"

/datum/sprite_accessory/hair/short_side //cepha - bubber port end
	name = "Short (Side)"
	icon = 'modular_iris/icons/mob/species/human/hair.dmi'
