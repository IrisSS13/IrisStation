/mob/living/basic/blackmesa/xen/houndeye
	...
	var/static/list/charge_sounds = list(
		'modular_iris/modules/black_mesa/sound/mobs/houndeye/charge1.ogg',
		'modular_iris/modules/black_mesa/sound/mobs/houndeye/charge2.ogg',
		'modular_iris/modules/black_mesa/sound/mobs/houndeye/charge3.ogg'
	)
