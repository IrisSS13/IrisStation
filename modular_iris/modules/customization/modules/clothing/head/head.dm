/obj/item/clothing/head/iris
	icon = 'modular_iris/icons/obj/clothing/head/head.dmi'
	worn_icon = 'modular_iris/icons/obj/clothing/head/head.dmi'
	supports_variations_flags = CLOTHING_SNOUTED_VARIATION_NO_NEW_ICON
	dog_fashion = null

/obj/item/clothing/head/iris/headband_thin
	name = "thin headband"
	desc = "A small, colored headband tied thin."
	icon = 'icons/map_icons/clothing/head/_head.dmi'
	icon_state = "/obj/item/clothing/head/iris/headband_thin"
	post_init_icon_state = "headband_thin"
