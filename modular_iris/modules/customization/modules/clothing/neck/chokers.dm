...
/obj/item/clothing/neck/choker/spike
	name = "spiked choker"
	desc = "A cool choker to show off your edgy style."
	icon = 'modular_iris/modules/GAGS/icons/chokers/spiked_choker.dmi'
	worn_icon = 'modular_iris/modules/GAGS/icons/chokers/spiked_choker.dmi'
	icon_state = "spike"
	greyscale_config = /datum/greyscale_config/choker_spike
	greyscale_config_worn = /datum/greyscale_config/choker_spike/worn
