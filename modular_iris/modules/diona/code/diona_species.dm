...
/datum/species/diona/on_species_gain(mob/living/carbon/human/H)
	...
	ADD_TRAIT(H, TRAIT_MOBILE, SPECIES_DIONA)
	H.update_mob_height()
	RegisterSignal(H, COMSIG_LIVING_HEALTH_UPDATE, PROC_REF(refresh_health))
...
/datum/species/diona/on_species_loss(mob/living/carbon/human/H, datum/species/new_species, pref_load)
	...
	REMOVE_TRAIT(H, TRAIT_MOBILE, SPECIES_DIONA)
	qdel(drone_ref)
