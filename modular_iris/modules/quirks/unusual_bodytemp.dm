...
/datum/quirk_constant_data/unusual_bodytemp
	...
	customization_options = list(/datum/preference/numeric/bodytemp_customization,)
...
/datum/quirk/unusual_bodytemp/post_add()
	...
	difference = prefs.read_preference(/datum/preference/numeric/bodytemp_customization)
