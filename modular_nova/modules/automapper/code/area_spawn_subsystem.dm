...
/datum/area_spawn
	...
	var/list/blacklisted_stations = list("Biodome", "Kilo Station", "Void Raptor", "Ouroboros", "Snowglobe Station", "Runtime Station", "MultiZ Debug", "Gateway Test", "Blueshift", "SerenityStation")
