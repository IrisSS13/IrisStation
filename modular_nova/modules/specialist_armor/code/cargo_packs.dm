/datum/supply_pack/security/armory/soft_armor
	...
	desc = "Contains three sets of SolGov-made soft body armor and matching helmets."
...
/datum/supply_pack/security/armory/hardened_armor
	...
	desc = "Contains three sets of SolGov-made hardened body armor and matching helmets."
	cost = CARGO_CRATE_VALUE * 5
	contains = list(
...
/datum/supply_pack/security/armory/sacrificial_armor
	...
	desc = "Contains three sets of SolGov-made sacrificial body armor and matching helmets."
	cost = CARGO_CRATE_VALUE * 5
	contains = list(
