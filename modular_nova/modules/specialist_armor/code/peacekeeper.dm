...
/obj/item/clothing/suit/armor/sf_peacekeeper/examine_more(mob/user)
	...
	. += "A common SolGov designed armor vest for a common cause, not having your innards become outards. \
		...
		it is a common sight on SolGov peacekeepers around the galaxy, alongside other misfits and corporate baddies \
		across the galaxy."
...
/obj/item/clothing/head/helmet/sf_peacekeeper
	...
	desc = "A large, almost always ill-fitting helmet painted in bright blue. It proudly bears the emblems of SolGov on its sides. \
...
/obj/item/clothing/head/helmet/sf_peacekeeper/examine_more(mob/user)
	...
	. += "A common SolGov designed ballistic helmet for a common cause, keeping your brain inside your head. \
