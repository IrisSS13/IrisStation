      ...
      <Section title="Functions">
        <Flex direction="column">
          ...
          {!!canMakeAnnouncement && (
            <Button
              icon="bullhorn"
              content="Call Sol Government 911: Marshals Response"
          ...
          {!!canMakeAnnouncement && (
            <Button
              icon="bullhorn"
              content="Call Sol Government 811: Advanced Atmospherics Response"
          ...
          {!!canMakeAnnouncement && (
            <Button
              icon="bullhorn"
              content="Call Sol Government 911: Medical Response"
